...
class Programmer extends MainClass implements ApplicationCreatorInterface
{
    ...
    public string $functional = 'может заниматься разработкой приложения:';
    public string $specific = 'пишет код';
    public function getAppCreator(): string
    {
        return "$this->functional $this->specific";
    }

    public function getAbout(): string
    {
        return "$this->surname $this->name, позиция: $this->position, зарплата: $this->salary $this->currency, ".$this->getAppCreator().PHP_EOL;
    }
